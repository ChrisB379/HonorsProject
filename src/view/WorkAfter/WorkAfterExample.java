...
/**
 * This GUI gives an example of how the algorithm used works.
 * 
 * It also asks the user to insert an integer value to be used as a parameter in their worked examples
 * 
...
public class WorkAfterExample extends JPanel implements Observer {
	...
	public WorkAfterExample(IWorkAfter m) {
		...
		txtWorkAfter.setText("<code> \r\n&nbsp\t<font color = rgb(127,0,85)><b>public void</b></font> workAfter(<font color = rgb(127,0,85)><b>int</b> </font> n)"
				+ "{\r\n<br>\t\t\r\n<br>&nbsp\t\t&nbsp<font color = rgb(127,0,85)><b>if</b> </font>(n == 1)\r\n<br>&nbsp\t\t\t&nbsp&nbsp System."
				+ "<font color = rgb(0,0,192)>out</font>.println(\"<font color = rgb(0,0,192)>Base case statement, showing the value of n is</font> \" + n);"
				+ "\r\n<br>\t\t\r\n<br>&nbsp\t\t&nbsp<font color = rgb(127,0,85)><b>else</b> </font>\r\n<br>&nbsp\t\t\t&nbsp&nbsp workAfter(n-1);\r\n<br>\t\t\r\n<br>\t\t\r\n<br>"
				+ "&nbsp\t\t&nbsp System.<font color = rgb(0,0,192)>out</font>.println(\""
		...
		txtHowItWorks.setText("<html><font face=\"cambria\", size = 4>\r\nHow this algorithm works:\r\n<br>\r\n<br>"
				+ "Step 1:\tThe parameter is checked by the base case\r\n<br>"
				+ "Step 2:\tIf the base case is not met then we go to the else statement; the recursive call\r\n<br>"
				+ "Step 3:\tRecursively this method is called until the base is met\r\n<br>"
				+ "Step 4:\tOnce this happens the print statement in the base case is printed\r\n<br>"
				+ "Step 5:\tThen the work after the recursive call is done and the final print statement is printed showing n*2 for each recursive call\r\n<br>\r\n<br>"
