...
public class ReturnValueExample extends JPanel {
	...
	public ReturnValueExample() {
		...
		JTextArea txtrNextYouWill = new JTextArea();
		txtrNextYouWill.setBackground(UIManager.getColor("Panel.background"));
		txtrNextYouWill.setText("Next you will be working through your own example of this algorithm. Please enter a number in the field provided which will be the parameter for your algorithm. factorial(n)");
		txtrNextYouWill.setWrapStyleWord(true);
		txtrNextYouWill.setLineWrap(true);
		...
		groupLayout.setVerticalGroup(
			groupLayout.createParallelGroup(Alignment.LEADING)
				.addGroup(groupLayout.createSequentialGroup()
					.addContainerGap()
					.addComponent(txtrOnceAgainThis, GroupLayout.PREFERRED_SIZE, 697, Short.MAX_VALUE)
					.addGroup(groupLayout.createParallelGroup(Alignment.LEADING)
