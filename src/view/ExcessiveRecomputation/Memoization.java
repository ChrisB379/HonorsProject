...
public class Memoization extends JPanel {
	...
	public Memoization() {
		...
		txtMemoAlgorithm.setText("<html><font face=\"cambria\", size = 4>\r\n<b>Memoization</b>\r\n<br>Memoization is the solution to excessive recomputation. It stores results of calculations in some "
				+ "way such as a list so when a calculation is repeated then the result can simply be fetched which is much faster and more efficient than recalculating eveytime. "
				+ "The first time a calculation is done, if it is not in the \"list\" then the calculation and result will be added to the list so it can be used later if needed.\r\n<br>\r\n<br> "
				+ "The algorithm for memoization in the fibonacci algorithm is as follows:\r\n<br><code>\r\n<br> \tint helperMemory[];\r\n<br>\r\n<br>\t<font color = rgb(127,0,85)> "
				+ "<b>public int</b> </font> fibMemoization(<font color = rgb(127,0,85)> <b>int</b> </font> n){\r\n<br>\t\t&nbsp&nbsp<font color = rgb(63,127,95)>//If there is no helper memory, "
				+ "then initialise it to the size of n</font>\r\n<br>\t\t&nbsp&nbsp<font color = rgb(127,0,85)> <b>if</b> </font>(<font color = rgb(0,0,192)>helperMemory</font> == <font color = rgb(127,0,85)>"
				...
				+ " <b>if</b></font>(<font color = rgb(0,0,192)>helperMemory</font>[n-1] != 0)\r\n<br>\t         &nbsp&nbsp&nbsp&nbsp <font color = rgb(127,0,85)> <b>return</b></font> "
				+ "<font color = rgb(0,0,192)>helperMemory</font>[n-1];\r\n<br>\t    \r\n<br>\t      &nbsp&nbsp<font color = rgb(127,0,85)> <b>else</b></font>\r\n<br>\t   &nbsp&nbsp  "
				+ "{\r\n<br>\t    \t&nbsp&nbsp&nbsp&nbsp<font color = rgb(63,127,95)>//Recursive call</font>\r\n<br>\t        &nbsp&nbsp&nbsp&nbsp<font color = rgb(0,0,192)>helperMemory</font>"
				+ "[n-1] = fibMemoization(n - 1) + fibMemoization(n - 2);\r\n<br>\t        &nbsp&nbsp&nbsp&nbsp <font color = rgb(127,0,85)> <b>return</b></font> <font color = rgb(0,0,192)>helperMemory</font>[n-1];\r\n<br>\t "
